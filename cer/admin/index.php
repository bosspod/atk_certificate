...
<section class="about-area pt-125 pb-130">
			<center>
        	<div class="col-lg-11">
			<h2 class="mt-80">ใบรับรอง ATK ทั้งหมด</h2>
			<hr/>
				...
				if(mysqli_num_rows($sql) == 0){
					...
					while($row = mysqli_fetch_assoc($sql)){
						...
						<tr>
							...
							<td>'.$row['id'].'</td>
                            <td>'.$row['name'].'</td>
                            <td>'.$row['outsite_name'].'</td>
                            <td>'.$row['qr_data'].'</td>
							<td> 
							<img src="../atk/'.$row['file_name'].'.jpg" width="100px" height="100px"> 
							</td>
							<td> 
							<img src="../cer/'.$row['file_name'].'.jpg" width="100px" height="100px"> 
							</td>
							<td> 
							<img src="../qr/'.$row['file_name'].'.jpg" width="100px" height="100px"> 
							</td>
							<td>
