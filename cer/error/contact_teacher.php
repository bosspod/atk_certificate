...
<body>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="section-title text-center">
                        <h2 class="title mt-60 mb-70">ระบบรับใบรับรอง ATK</h2>
                        <p></p>
                    </div> 
                </div>
            </div>
	...
	<div class="contact-title text-center">ขอแสดงความเสียใจที่นักเรียนติดโควิด</div>
	<div class="contact-title text-center mt-4">โปรดติดต่อคุณครูเพื่อแจ้งข่าว และ รับความช่วยเหลือ</div>
	<div class="mt-25"><div>
	<div class="contact-description text-center">โปรดติดต่อคุณครูได้ที่เบอร์ <a href="tel:0966752374">096-675-2374</a></div> 
		<div class="text-center mt-50">
		<a class="main-btn ml-10 mt-10" href="../../">กลับสู่หน้าหลัก</a>
		</div>
    </section>
    </header>
                    ...
                    <div class="col-lg-8">
                        <div class="footer-content text-center">
                            ...
                            <ul>
									...
									<li><a target="_blank" href="https://twitter.com/Bosszaz77343917"><i class="lni-twitter-original"></i></a></li>
                            </ul>
                        </div> 
                    </div>
                </div> 
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="copyright-text text-center pt-20">
                            <p>ลิขสิทธิ์© 2020. พศวีร์ วนาธรรม</p>
                        </div> 
                    </div>
                </div> 
            </div> 
    ...
    <a href="#" class="back-to-top"><img src = "../../../img/Logo/up_arrow.png"></i></a>
	...
	<script src="../../js/copy-th.js"></script>
</body>
